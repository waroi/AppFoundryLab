...
const copy = {
  en: {
    ...
    systemStatus: {
      ...
      runtimeKnobsTitle: "Runtime knobs",
      runtimeKnobsDescription:
        "Review these effective values together with the dependency behavior matrix when diagnosing admin/runtime degradation.",
      requestLogTrustedProxyCidrs: "Trusted proxy CIDRs",
      noTrustedProxyCidrs: "No trusted proxies configured; request logs use the direct remote address.",
      loggerHealthTimeout: "Logger health timeout",
      loggerIngestTimestampMaxAge: "Logger ingest max age",
      loggerIngestTimestampMaxFutureSkew: "Logger ingest future skew",
      runtimeKnobsNote:
        "These values are snapshotted at gateway start and mirror the shared APP_ENV_FILE contract used by the gateway and logger services.",
      dependencyPoliciesTitle: "Dependency behavior by route",
      dependencyPoliciesDescription:
        "This matrix explains how dependency-backed routes behave in strict, non-strict, and degraded runtime states.",
      dependencyPoliciesRoute: "Route",
      dependencyPoliciesDependency: "Dependency",
      dependencyPoliciesStrictMode: "Strict mode",
      dependencyPoliciesNonStrictMode: "Non-strict mode",
      dependencyPoliciesRuntimeBehavior: "Runtime behavior",
  ...
  tr: {
    ...
    systemStatus: {
      ...
      workerTls: "Worker TLS",
      runtimeKnobsTitle: "Runtime knob'lari",
      runtimeKnobsDescription:
        "Yonetici/runtime degrade durumlarini yorumlarken bu efektif degerleri asagidaki bagimlilik davranisi matrisiyle birlikte okuyun.",
      requestLogTrustedProxyCidrs: "Guvenilen proxy CIDR'lari",
      noTrustedProxyCidrs:
        "Guvenilen proxy tanimli degil; request log kayitlari dogrudan remote adresi kullanir.",
      loggerHealthTimeout: "Logger health timeout",
      loggerIngestTimestampMaxAge: "Logger ingest azami yasi",
      loggerIngestTimestampMaxFutureSkew: "Logger ingest ileri zaman kaymasi",
      runtimeKnobsNote:
        "Bu degerler gateway baslangicinda snapshot olarak alinir ve gateway ile logger servislerinin kullandigi ortak APP_ENV_FILE kontratini yansitir.",
      dependencyPoliciesTitle: "Rotalara gore bagimlilik davranisi",
      dependencyPoliciesDescription:
        "Bu matris, bagimlilik kullanan rotalarin kati, esnek ve degrade runtime durumlarinda nasil davrandigini aciklar.",
      dependencyPoliciesRoute: "Rota",
      dependencyPoliciesDependency: "Bagimlilik",
      dependencyPoliciesStrictMode: "Kati mod",
      dependencyPoliciesNonStrictMode: "Esnek mod",
      dependencyPoliciesRuntimeBehavior: "Runtime davranisi",
      legacyApi: "Legacy API",
